...
public class ModTextures
{
    ...
    public static final ITexturePalette MASONRY_SIMPLE = TexturePaletteRegistry.addTexturePallette("masonry_simple", "masonry_simple", 
            new TexturePaletteSpec(ExoticMatter.INSTANCE).withVersionCount(1).withScale(TextureScale.SINGLE).withLayout(TextureLayout.MASONRY_5)
            .withRotation(FIXED.with(ROTATE_NONE)).withRenderIntent(TextureRenderIntent.OVERLAY_ONLY).withGroups(TextureGroup.STATIC_BORDERS));

    public static final ITexturePalette BORDER_SINGLE_PINSTRIPE = TexturePaletteRegistry.addBorderSingle(ExoticMatter.INSTANCE, "border_single_pinstripe");
    public static final ITexturePalette BORDER_INSET_PINSTRIPE = TexturePaletteRegistry.addBorderSingle(ExoticMatter.INSTANCE, "border_inset_pinstripe");
    public static final ITexturePalette BORDER_GRITTY_INSET_PINSTRIPE = TexturePaletteRegistry.addBorderRandom(ExoticMatter.INSTANCE, "border_gritty_inset_pinstripe", false, false);
    public static final ITexturePalette BORDER_SINGLE_LINE = TexturePaletteRegistry.addBorderSingle(ExoticMatter.INSTANCE, "border_single_line");
    public static final ITexturePalette BORDER_SINGLE_BOLD_LINE = TexturePaletteRegistry.addBorderSingle(ExoticMatter.INSTANCE, "border_single_bold_line");
    public static final ITexturePalette BORDER_SINGLE_FAT_LINE = TexturePaletteRegistry.addBorderSingle(ExoticMatter.INSTANCE, "border_single_fat_line");
    public static final ITexturePalette BORDER_GRITTY_FAT_LINE = TexturePaletteRegistry.addBorderRandom(ExoticMatter.INSTANCE, "border_gritty_fat_line", false, false);
    public static final ITexturePalette BORDER_DOUBLE_MIXED_LINES = TexturePaletteRegistry.addBorderSingle(ExoticMatter.INSTANCE, "border_double_mixed_lines");
    public static final ITexturePalette BORDER_DOUBLE_PINSTRIPES = TexturePaletteRegistry.addBorderSingle(ExoticMatter.INSTANCE, "border_double_pinstripes");
    public static final ITexturePalette BORDER_INSET_DOUBLE_PINSTRIPES = TexturePaletteRegistry.addBorderSingle(ExoticMatter.INSTANCE, "border_inset_double_pinstripes");
    public static final ITexturePalette BORDER_TRIPLE_MIXED_LINES = TexturePaletteRegistry.addBorderSingle(ExoticMatter.INSTANCE, "border_triple_mixed_lines");
    public static final ITexturePalette BORDER_DOUBLE_DOUBLE = TexturePaletteRegistry.addBorderSingle(ExoticMatter.INSTANCE, "border_double_double");
    public static final ITexturePalette BORDER_WHITEWALL = TexturePaletteRegistry.addBorderSingle(ExoticMatter.INSTANCE, "border_whitewall");
    public static final ITexturePalette BORDER_GRITTY_WHITEWALL = TexturePaletteRegistry.addBorderRandom(ExoticMatter.INSTANCE, "border_gritty_whitewall", false, false);
    
    public static final ITexturePalette BORDER_PINSTRIPE_DASH = TexturePaletteRegistry.addBorderSingle(ExoticMatter.INSTANCE, "border_pinstripe_dash");
    public static final ITexturePalette BORDER_INSET_DOTS_1 = TexturePaletteRegistry.addBorderSingle(ExoticMatter.INSTANCE, "border_inset_dots_1");
    public static final ITexturePalette BORDER_INSET_DOTS_2 = TexturePaletteRegistry.addBorderSingle(ExoticMatter.INSTANCE, "border_inset_dots_2");
    public static final ITexturePalette BORDER_INSET_PIN_DOTS = TexturePaletteRegistry.addBorderSingle(ExoticMatter.INSTANCE, "border_inset_pin_dots");
    public static final ITexturePalette BORDER_CHANNEL_DOTS = TexturePaletteRegistry.addBorderSingle(ExoticMatter.INSTANCE, "border_channel_dots");
    public static final ITexturePalette BORDER_CHANNEL_PIN_DOTS = TexturePaletteRegistry.addBorderSingle(ExoticMatter.INSTANCE, "border_channel_pin_dots");
    
    public static final ITexturePalette BORDER_CHANNEL_CHECKERBOARD = TexturePaletteRegistry.addBorderSingle(ExoticMatter.INSTANCE, "border_channel_checkerboard");
    public static final ITexturePalette BORDER_CHECKERBOARD = TexturePaletteRegistry.addBorderSingle(ExoticMatter.INSTANCE, "border_checkerboard");
    public static final ITexturePalette BORDER_GRITTY_CHECKERBOARD = TexturePaletteRegistry.addBorderRandom(ExoticMatter.INSTANCE, "border_gritty_checkerboard", false, false);
    
    public static final ITexturePalette BORDER_GROOVY_STRIPES = TexturePaletteRegistry.addBorderSingle(ExoticMatter.INSTANCE, "border_groovy_stripes");
    public static final ITexturePalette BORDER_GRITTY_GROOVES = TexturePaletteRegistry.addBorderRandom(ExoticMatter.INSTANCE, "border_gritty_grooves", false, false);
    public static final ITexturePalette BORDER_GROOVY_PINSTRIPES = TexturePaletteRegistry.addBorderSingle(ExoticMatter.INSTANCE, "border_groovy_pinstripes");
    public static final ITexturePalette BORDER_GRITTY_PINSTRIPE_GROOVES = TexturePaletteRegistry.addBorderRandom(ExoticMatter.INSTANCE, "border_gritty_pinstripe_grooves", false, false);
    
    public static final ITexturePalette BORDER_ZIGZAG = TexturePaletteRegistry.addBorderSingle(ExoticMatter.INSTANCE, "border_zigzag");
    public static final ITexturePalette BORDER_INVERSE_ZIGZAG = TexturePaletteRegistry.addBorderSingle(ExoticMatter.INSTANCE, "border_inverse_zigzag");
    public static final ITexturePalette BORDER_CAUTION = TexturePaletteRegistry.addBorderSingle(ExoticMatter.INSTANCE, "border_caution");
    public static final ITexturePalette BORDER_FILMSTRIP = TexturePaletteRegistry.addBorderSingle(ExoticMatter.INSTANCE, "border_filmstrip");
    public static final ITexturePalette BORDER_CHANNEL_LINES = TexturePaletteRegistry.addBorderSingle(ExoticMatter.INSTANCE, "border_channel_lines");
    public static final ITexturePalette BORDER_SIGNAL = TexturePaletteRegistry.addBorderSingle(ExoticMatter.INSTANCE, "border_signal");
    public static final ITexturePalette BORDER_GRITTY_SIGNAL = TexturePaletteRegistry.addBorderRandom(ExoticMatter.INSTANCE, "border_gritty_signal", false, false);
    public static final ITexturePalette BORDER_LOGIC = TexturePaletteRegistry.addBorderRandom(ExoticMatter.INSTANCE, "border_logic", true, false);
    public static final ITexturePalette BORDER_INVERSE_TILE_1 = TexturePaletteRegistry.addBorderRandom(ExoticMatter.INSTANCE, "border_inverse_logic_1", true, true);
    public static final ITexturePalette BORDER_INVERSE_TILE_2 = TexturePaletteRegistry.addBorderRandom(ExoticMatter.INSTANCE, "border_inverse_logic_2", true, true);
    ...
    public static final ITexturePalette BIGTEX_WEATHERED_STONE = TexturePaletteRegistry.addTexturePallette("weathered_smooth_stone", "weathered_smooth_stone", 
            new TexturePaletteSpec(ExoticMatter.INSTANCE).withVersionCount(1).withScale(TextureScale.MEDIUM).withLayout(TextureLayout.SIMPLE)
            .withRotation(CONSISTENT.with(ROTATE_NONE)).withRenderIntent(TextureRenderIntent.BASE_ONLY).withGroups(TextureGroup.STATIC_TILES));
    ...
    public static final ITexturePalette BIGTEX_FLUID_GLOW = TexturePaletteRegistry.addTexturePallette("fluid_glow", "fluid_glow", 
            new TexturePaletteSpec(ExoticMatter.INSTANCE).withVersionCount(1).withScale(TextureScale.MEDIUM).withLayout(TextureLayout.BIGTEX_ANIMATED)
    ...
    public static final ITexturePalette BIGTEX_STARFIELD = TexturePaletteRegistry.addTexturePallette("starfield", "starfield", 
            new TexturePaletteSpec(ExoticMatter.INSTANCE).withVersionCount(1).withScale(TextureScale.SMALL).withLayout(TextureLayout.BIGTEX_ANIMATED)
