...
public class MutablePolygonNxN extends AbstractLargePolygon<MutablePolygonNxN> implements IMutablePolygon
{
    ...
    protected MutablePolygonNxN(int order)
    {
        super();
        vertices = new IMutableVertex[1 << order];
    ...
    {
        super.setVertexImpl(vertexIndex, x, y, z, u, v, color);
        return this;
    }
    ...
    {
        super.setVertexImpl(vertexIndex, x, y, z, u, v, color, normX, normY, normZ);
        return this;
    }
