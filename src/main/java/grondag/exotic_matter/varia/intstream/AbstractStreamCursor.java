...
public abstract class AbstractStreamCursor<T extends AbstractStreamCursor<T>>
{
    ...
    /**
     * Moves cursor to beginning of collection, returning true if collection is non-empty.
     */
    ...
    /**
     * Moves cursor to next element in collection and return true.
     * Returns false if past the last element in collection.
     * If returns false, cursor may not have a value. 
     */
    public boolean next()
    {
        int i = this.index + 1;
