...
/**
 * Assigns an integer handle to object instances that can later
 * be used to retrieve the same instance. Useful when need
 * to serialize an object (in memory) to a primitive type.<p>
 * 
 * Pointers will always be positive, non-zero values.<p>
 * 
