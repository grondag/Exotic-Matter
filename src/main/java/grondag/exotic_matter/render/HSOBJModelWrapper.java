...
public class HSOBJModelWrapper implements IModel
{
    ...
    @Override
    public @Nonnull IBakedModel bake(@Nonnull IModelState state, @Nonnull VertexFormat format, @Nonnull Function<ResourceLocation, TextureAtlasSprite> bakedTextureGetter)
    {
    ...
    @Override
    public @Nonnull Collection<ResourceLocation> getTextures()
    {
        return this.wrapped.getTextures();
    }
    
    @Override
    public @Nonnull IModel process(@Nonnull ImmutableMap<String, String> customData)
    {
        return new HSOBJModelWrapper(this.wrapped.process(customData));
    }
    
    @Override
    public @Nonnull IModel retexture(@Nonnull ImmutableMap<String, String> textures)
    {
